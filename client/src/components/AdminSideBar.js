...
const AdminSideBar = () => {
    return(
        <aside id="logo-sidebar" class="top-0 left-0 z-40 w-64 hidden sm:block h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between" aria-label="Sidebar">
        <h5 id="drawer-navigation-label" class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400 absolute top-2.5 start-5">Menu</h5>
  ...
  <ul className="space-y-2 font-medium">
     ...
     <li>
        <a href="#" className="flex items-center text-left p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
           ...
           <span className="flex-1 ml-5 whitespace-nowrap">Categories</span>
     ...
     <li>
        <a href="#" className="flex items-center text-left p-2 text-gray-900 rounded-lg dark:text-gray-500 group">
           <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
...
<div className="flex items-center justify-center w-[90%] mb-4 m-auto absolute bottom-1 right-3">
  ...
  <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">RIMAS</span>

  <img className="h-8" src="/images/diamond.png" alt="Diamond Logo" />

      {/* <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" /> */}
      <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">STORE</span>
    </a>
</div>   
</div>
</aside>
